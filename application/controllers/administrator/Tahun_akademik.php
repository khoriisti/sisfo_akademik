<?php 
	...
	class Tahun_akademik extends CI_Controller
	{
		...
		{
			$data['tahun_akademik'] = $this->tahunakademik_model->
			tampil_data('tahun_akademik')->result();
		...
		public function tambah_tahun_akademik_aksi()
		{
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->tahunakademik_model->insert_data($data);
				...
				redirect (base_url('administrator/tahun_akademik'));
			}
		}
		...
		public function update_aksi()
		{
			...
			$this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible fade show" role="alert">
					  Data Tahun Akademik Berhasil Update!
					  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
					    <span aria-hidden="true">&times;</span>
					  </button>
					</div>');
